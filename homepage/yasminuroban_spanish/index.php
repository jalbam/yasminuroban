...
<html>
    <head>
        <title>Yasminuroban &copy; (por Joan Alba Maldonado)</title>
                ...
                function iniciar_juego(numero_nivel)
                 {
                    ...
                    document.getElementById("personaje").innerHTML = '<img src="img/yas_down1.gif" id="personaje_imagen" title="Aqu&iacute; est&aacute;s t&uacute;" alt="@" width="'+celda_width+'" height="'+celda_height+'" border="0" hspace="0" vspace="0">';
                    ...
                    document.getElementById("mensaje").innerHTML = "Bienvenido al Nivel: "+nivel;
                    ...
                    if (nivel <= 1 && !se_ha_saludado) { alert("Bienvenido al primer nivel. Coloca todas las botellas en sus copas."); se_ha_saludado = true; }
                 }
                ...
                function actualizar_barra()
                 {
                    ...
                    if (!formulario_nivel) { document.getElementById("barra_estado").innerHTML = "Nivel: "+nivel+"&nbsp; |&nbsp; Movimientos: "+eval(numero_movimientos_mostrar); }
                ...
                function generar_formulario_nivel()
                 {
                    ...
                    formulario_nivel += 'Nivel: <select name="selector_nivel" onChange="javascript:saltar_nivel(document.getElementById(\'formulario_nivel\').selector_nivel.value);">';
                    ...
                    formulario_nivel += "&nbsp; |&nbsp; Movimientos: "+eval(numero_movimientos_mostrar)+"</form>";
                ...
                function saltar_nivel(numero_nivel)
                 {
                    ...
                    if (confirm("Presiona aceptar si deseas cambiar al nivel "+numero_nivel))
                     {
                        //Se cambia de nivel:
                ...
                function pintar_mapa(pintar_personaje)
                 {
                    ...
                    if (pintar_personaje) { document.getElementById("personaje").innerHTML = '<img src="img/yas_down1.gif" id="personaje_imagen" title="Aqu&iacute; est&aacute;s t&uacute;" alt="@" width="'+celda_width+'" height="'+celda_height+'" border="0" hspace="0" vspace="0">'; }
                ...
                function pasar_nivel()
                 {
                    ...
                    if (nivel < numero_niveles)
                     {
                        ...
                        document.getElementById("mensaje").innerHTML = "Enhorabuena, has completado el nivel "+nivel;
                        //Se hace visible el mensaje:
                        document.getElementById("mensaje").style.visibility = "visible";
                        //Se oculta el mensaje despues de 3 segundos:
                        setTimeout("document.getElementById('mensaje').style.visibility='hidden'", 3000); 
                        //Se da la enhorabuena con un alert:
                        alert("Enhorabuena, te has pasado el nivel "+nivel);
                    ...
                    //Si ya estamos en el ultimo nivel, se notifica que se ha acabado el juego y se inicia otra vez:
                     ...
                     {
                        //Se informa del fin del juego en el mensaje:
                        document.getElementById("mensaje").innerHTML = "Has acabado los niveles. Fin del juego.";
                        //Se hace visible el mensaje:
                        document.getElementById("mensaje").style.visibility = "visible";
                        //Se oculta el mensaje despues de 3 segundos:
                        setTimeout("document.getElementById('mensaje').style.visibility='hidden'", 3000); 
                        //Se alerta de que se han acabado los niveles:
                        alert("Has acabado los niveles. Fin del juego.");
                ...
                function reiniciar_nivel()
                 {
                    ...
                    if (confirm("Pulsa aceptar para reiniciar el nivel "+nivel))
                     {
                        //Si el nivel seleccionado es el ultimo, y se ha enviado uno por la url (GET), entonces volvemos a generar el mapa y salimos de la funcion:
                        if (mapa_url_recogido && nivel == numero_niveles) { recoger_mapa_url(); return; }
                ...
                function recoger_mapa_url()
                 {
                    ...
                    //...y si no, procede:
                    else
                     {
                        ...
                        if (mapa_url_refinado.length != parseInt(unescape(mapa_width_url))*parseInt(unescape(mapa_height_url))) { alert("Imposible cargar el mapa enviado por url ya que no corresponde al alto y ancho enviados."); mapa_width = 10; mapa_height = 10; preparar_mapa(); return; }
    ...
    <body bgcolor="#ffffff" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" onLoad="javascript:recoger_mapa_url();" onKeyDown="javascript:pulsar_tecla(event, 'onkeypress');" onKeyPress="javascript:pulsar_tecla(event, 'onkeydown');">
        ...
        <div id="botones" style="visibility:visible; background:transparent; color:#000000; left:10px; top:10px; width:600px; height:50px; padding:0px; position:absolute; font-size:12px; font-family:arial; line-height:18px; z-index:5;">
            <a href="javascript:deshacer_accion();" title="Deshacer movimiento (U)"><img src="img/deshacer.gif" title="Deshacer movimiento (U)" alt="Deshacer movimiento" border="0" hspace="0" vspace="0" width="40" height="40"></a>
            <a href="javascript:rehacer_accion();" title="Rehacer movimiento (Y)"><img src="img/rehacer.gif" title="Rehacer movimiento (Y)" alt="Rehacer movimiento" border="0" hspace="0" vspace="0" width="40" height="40"></a>
            <a href="javascript:reiniciar_nivel();" title="Reiniciar nivel (R)"><img src="img/reiniciar.gif" title="Reiniciar nivel (R)" alt="Reiniciar nivel" border="0" hspace="0" vspace="0" width="40" height="40"></a>
            &nbsp;&nbsp; <img src="img/editor.gif" title="Editor de niveles" alt="Editor de niveles" border="0" hspace="0" vspace="0" width="40" height="40" style="cursor: pointer; cursor: hand;" onClick="javascript:if (confirm('Presiona aceptar si deseas cambiar al editor de mapas (y finalizar el juego actual)')) { window.location.href=url_editor; }"></a>
            <div id="informacion" style="visibility:visible; background:transparent; color:#000000; left:190px; top:0px; width:480px; height:50px; padding:0px; position:absolute; font-size:12px; font-family:arial; line-height:18px; z-index:6;">
                ...
                <br>
                &copy; Yasminuroban por Joan Alba Maldonado
            </div>
        </div>
        <!-- Fin de Botones. -->
        <!-- Zona de Juego: -->
        <div id="zona_juego" style="visibility:visible; background:transparent; color:#000000; left:10px; top:60px; width:340px; height:40px; padding:0px; position:absolute; font-size:1px; line-height:1px; z-index:1;">
            ...
            <div id="personaje" style="visibility:hidden; background:transparent; color:#000000; left:0px; top:0px; width:40px; height:40px; padding:0px; position:absolute; font-size:1px; line-height:1px; z-index:3;">
              <img src="img/yas_down1.gif" id="personaje_imagen" title="Aqu&iacute; est&aacute;s t&uacute;" alt="@" width="40" height="40" border="0" hspace="0" vspace="0">
            </div>
            <!-- Fin de Personaje. -->
            <!-- Mensaje: -->
        ...
        <div id="informacion_autor" style="left:10px; top:530px; height:0px; position:absolute; border:0px; padding:0px; background:transparent; color:#333333; text-align:left; line-height:20px; text-decoration:none; font-family:verdana; font-size:10px; z-index:10;">
            &copy; <b>Yasminuroban</b> 0.68a por <i>Joan Alba Maldonado</i> (<a href="mailto:granvino@granvino.com;">granvino@granvino.com</a>) &nbsp;<sup>(100% DHTML)</sup>
            <br>&nbsp;&nbsp;- Prohibido publicar, reproducir o modificar sin citar expresamente al autor original.
            <br>
            &nbsp;&nbsp;<tt>* Flechas para mover y empujar, 'U' para deshacer jugada, 'Y' para rehacerla, y 'R' para reiniciar nivel. En Opera, dejar el rat&oacute;n encima del area de juego.</tt>
            <br>
